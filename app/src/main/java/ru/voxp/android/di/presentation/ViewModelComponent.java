...
@ViewModelScope
@Component(dependencies = {UseCaseProvider.class, ManagerProvider.class, ApplicationProvider.class}, modules = ViewModelModule.class)
interface ViewModelComponent extends ViewModelProvider {
